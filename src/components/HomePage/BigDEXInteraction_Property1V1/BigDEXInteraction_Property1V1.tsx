...
import classes from './BigDEXInteraction_Property1V1.module.css';
...
/* @figmaId 2:279 */
export const BigDEXInteraction_Property1V1: FC<Props> = memo(function BigDEXInteraction_Property1V1(props = {}) {
  return (
